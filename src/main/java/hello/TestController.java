...
// latest
    ...
    @CrossOrigin(origins = "http://localhost:4200")
    @RequestMapping(value = "/loadData_prev", method = RequestMethod.POST)
    public ResultInfo getTest(@RequestBody FilterDTO filterDTO) {

        MapSqlParameterSource namedParameters = new MapSqlParameterSource("period_id", filterDTO.getPeriodId());
